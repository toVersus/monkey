...
func TestNextToken(t *testing.T) {
	// Like subset of Monkey language; not actual syntax at this time, but it' fine
	// because lexer's job is not to make sure meaning of the code but just to turn the input into tokens.
	input := `let five = 5;
let ten = 10;
